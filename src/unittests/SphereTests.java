...
public class SphereTests {
	...
	ArrayList<Point3D> myintersectionPoints=(ArrayList<Point3D>) sphere2.findIntersections(ray1);
	...
	ArrayList<Point3D> myintersectionPoints1=(ArrayList<Point3D>) sphere2.findIntersections(ray2);
	...
	ArrayList<Point3D> myintersectionPoints2=(ArrayList<Point3D>) sphere2.findIntersections(ray3);
	...
	ArrayList<Point3D> myintersectionPoints3=(ArrayList<Point3D>) sphere2.findIntersections(ray4);
	...
	ArrayList<Point3D> myintersectionPoints4=(ArrayList<Point3D>) sphere2.findIntersections(ray5);
	...
	intersectionPoints.clear();
	intersectionPoints.add(new Point3D(0,-3,0));
	ArrayList<Point3D> myintersectionPoints5=(ArrayList<Point3D>) sphere2.findIntersections(ray6);
	...
	intersectionPoints.clear();
	intersectionPoints.add(new Point3D(0,1,0));
	ArrayList<Point3D> myintersectionPoints6=(ArrayList<Point3D>) sphere2.findIntersections(ray7);
	...
	intersectionPoints.add(new Point3D(1,1,0));
	   List<Point3D> myintersectionPoints7 =sphere.findIntersections(ray8);
	...
	ArrayList<Point3D> myintersectionPoints8=(ArrayList<Point3D>) sphere2.findIntersections(ray9);
	assertEquals(null,myintersectionPoints8);
	 
	  // TC18: Ray starts after sphere
	Ray ray10 = new Ray (new Vector(0,1,0),new Point3D(0,2,0));
	ArrayList<Point3D> myintersectionPoints9=(ArrayList<Point3D>) sphere2.findIntersections(ray10);
	...
	ArrayList<Point3D> myintersectionPoints10=(ArrayList<Point3D>) sphere2.findIntersections(ray11);
	assertEquals(null,myintersectionPoints10);
	  // TC20: Ray starts at the tangent point
	Ray ray12 = new Ray (new Vector(2,0,0),new Point3D(0,1,0));
	ArrayList<Point3D> myintersectionPoints11=(ArrayList<Point3D>) sphere2.findIntersections(ray12);
	assertEquals(null,myintersectionPoints11);
	  // TC21: Ray starts after the tangent point
	Ray ray13 = new Ray (new Vector(2,0,0),new Point3D(1,1,0));
	ArrayList<Point3D> myintersectionPoints12=(ArrayList<Point3D>) sphere2.findIntersections(ray13);
	assertEquals(null,myintersectionPoints12);

	// **** Group: Special cases
	  // TC19: Ray's line is outside, ray is orthogonal to ray start to sphere's center line
	Ray ray14 = new Ray (new Vector(2,0,0),new Point3D(0,6,0));
	ArrayList<Point3D> myintersectionPoints13=(ArrayList<Point3D>) sphere2.findIntersections(ray14);
